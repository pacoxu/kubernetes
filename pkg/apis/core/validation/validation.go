...
func ValidationOptionsForPersistentVolumeClaim(pvc, oldPvc *core.PersistentVolumeClaim) PersistentVolumeClaimSpecValidationOptions {
	...
	allErrors := unversionedvalidation.ValidateLabelSelector(oldPvc.Spec.Selector, false, field.NewPath("labelSelector"))
	if len(allErrors) > 0 {
...
func ValidationOptionsForPersistentVolumeClaimTemplate(claimTemplate, oldClaimTemplate *core.PersistentVolumeClaimTemplate) PersistentVolumeClaimSpecValidationOptions {
	...
	allErrors := unversionedvalidation.ValidateLabelSelector(oldClaimTemplate.Spec.Selector, false, field.NewPath("labelSelector"))
	if len(allErrors) > 0 {
		// If the old object had an invalid label selector, continue to allow it in the new object
		opts.AllowInvalidLabelValueInSelector = true
	}
...
func validateAffinity(affinity *core.Affinity, allowInvalidLabelValueInSelector bool, fldPath *field.Path) field.ErrorList {
	allErrs := field.ErrorList{}
	...
	if affinity != nil {
		...
		if affinity.PodAffinity != nil {
			allErrs = append(allErrs, validatePodAffinity(affinity.PodAffinity, allowInvalidLabelValueInSelector, fldPath.Child("podAffinity"))...)
		}
		if affinity.PodAntiAffinity != nil {
			allErrs = append(allErrs, validatePodAntiAffinity(affinity.PodAntiAffinity, allowInvalidLabelValueInSelector, fldPath.Child("podAntiAffinity"))...)
		}
	}
...
func ValidatePodSpec(spec *core.PodSpec, podMeta *metav1.ObjectMeta, fldPath *field.Path, opts PodValidationOptions) field.ErrorList {
	...
	allErrs = append(allErrs, validateAffinity(spec.Affinity, opts.AllowInvalidLabelValueInSelector, fldPath.Child("affinity"))...)
...
func ValidatePodAffinityTermSelector(podAffinityTerm core.PodAffinityTerm, allowInvalidLabelValueInSelector bool, fldPath *field.Path) field.ErrorList {
	var allErrs field.ErrorList
	allErrs = append(allErrs, unversionedvalidation.ValidateLabelSelector(podAffinityTerm.LabelSelector, allowInvalidLabelValueInSelector, fldPath.Child("labelSelector"))...)
	allErrs = append(allErrs, unversionedvalidation.ValidateLabelSelector(podAffinityTerm.NamespaceSelector, allowInvalidLabelValueInSelector, fldPath.Child("namespaceSelector"))...)
	return allErrs
}
