...
func (strategy) Validate(ctx context.Context, obj runtime.Object) field.ErrorList {
	...
	opts := &validation.ClusterRoleValidateOption{
...
func (strategy) ValidateUpdate(ctx context.Context, obj, old runtime.Object) field.ErrorList {
	...
	return append(errorList, validation.ValidateClusterRoleUpdate(newObj, opts, old.(*rbac.ClusterRole))...)
}
...
func allowValidateLabelValueInLabelSelector(role *rbac.ClusterRole) bool {
	if role.AggregationRule != nil {
		for i, selector := range role.AggregationRule.ClusterRoleSelectors {
			...
			allErrs := metav1validation.ValidateLabelSelector(&selector, false, fieldPath)
			if len(allErrs) > 0 {
				return true
			}
		}
